...
{
    default void setPosition(cameraPosition position)
        throws UnreachableArgument
    {
        setPosition(position, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setPosition(cameraPosition position, java.util.Map<String, String> context)
        throws UnreachableArgument
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<Void> setPositionAsync(cameraPosition position)
    {
        return _iceI_setPositionAsync(position, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setPositionAsync(cameraPosition position, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setPositionAsync(cameraPosition iceP_position, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setPosition", null, sync, _iceE_setPosition);
        f.invoke(true, context, null, ostr -> {
                     cameraPosition.ice_write(ostr, iceP_position);
                 }, null);
        return f;
    }
    ...
    default void setZoom(int zoom, java.util.Map<String, String> context)
        throws UnreachableArgument
    {
        try
        {
    ...
    default java.util.concurrent.CompletableFuture<Void> setZoomAsync(int zoom)
    {
        return _iceI_setZoomAsync(zoom, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setZoomAsync(int zoom, java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setZoomAsync(int iceP_zoom, java.util.Map<String, String> context, boolean sync)
    {
    ...
    default cameraPosition getPosition()
    {
        return getPosition(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default cameraPosition getPosition(java.util.Map<String, String> context)
    {
        return _iceI_getPositionAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<cameraPosition> getPositionAsync()
    {
        return _iceI_getPositionAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<cameraPosition> getPositionAsync(java.util.Map<String, String> context)
    {
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<cameraPosition> _iceI_getPositionAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<cameraPosition> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getPosition", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     cameraPosition ret;
                     ret = cameraPosition.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default byte[] getImage()
    {
        return getImage(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default byte[] getImage(java.util.Map<String, String> context)
    {
        return _iceI_getImageAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<byte[]> getImageAsync()
    {
        return _iceI_getImageAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<byte[]> getImageAsync(java.util.Map<String, String> context)
    {
        return _iceI_getImageAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<byte[]> _iceI_getImageAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<byte[]> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getImage", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     byte[] ret;
